    ...
    query: function () {
      this.$axios({
        ...
        timeout: 1000,
          ...
          .then(res => {
            this.clothe24=[]
            let alist=eval(res.data.alist)
            for (let i = 0; i < alist.length ; i++) {
              let o= {}
              o.cid = alist.at(i).cid
              o.cpid = alist.at(i).cpid
              o.cpic = alist.at(i).cpic
              o.cpr = alist.at(i).cpr
              o.cn = alist.at(i).cn
              o.cde = alist.at(i).cde
              o.cnum = alist.at(i).cnum
